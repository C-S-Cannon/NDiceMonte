...
setup(
    ...
    url='https://github.com/C-S-Cannon/NDiceMonte',
    author='Cameron Cannon',
    author_email='c_cannon@ucsb.edu',
    license='GPL-3.0',
    description="A python package for calculating and graphing various dice statistics for TTRPGs."
)
